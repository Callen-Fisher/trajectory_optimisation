...
traj_sim=[];
i=nNodesF1*5+3;
traj1=reshape(MinSoln(4:i),[5,nNodesF1]);
j=i+nNodesS*3;
traj2=reshape(MinSoln(i+1:j),[3,nNodesS]);
traj3=reshape(MinSoln(j+1:end),[5,nNodesF2]);
%% re run the simulation
%% FLIGHT 1
Tsample = MinSoln(1)/nNodesF1;
...
time_sim=[linspace(0,MinSoln(1),nNodesF1*100),linspace(MinSoln(1),MinSoln(1)+MinSoln(2),nNodesS*100),linspace(MinSoln(1)+MinSoln(2),MinSoln(1)+MinSoln(2)+MinSoln(3),nNodesF2*100)];
...
time=[linspace(0,MinSoln(1),nNodesF1+1),linspace(MinSoln(1),MinSoln(1)+MinSoln(2),nNodesS+1),linspace(MinSoln(1)+MinSoln(2),MinSoln(1)+MinSoln(2)+MinSoln(3),nNodesF2+1)];
time(nNodesF1+1)=[];
