...
tic % start the timer
[MinSoln,Problem,Guess,FVAL,LAMBDA,GRAD,HESSIAN,EXITFLAG,OUTPUT,adifuncs]=traj_opt_multipleshoot(nNodesF1,nNodesS,nNodesF2,pogo); % run the multipleshoot setup function
...
save(filename,'traj','traj_sim','time_F1','time_S','time_F2','nNodesF1','nNodesS','nNodesF2','MinSoln','Guess','pogo','Problem','FVAL','LAMBDA','GRAD','HESSIAN','EXITFLAG','OUTPUT','adifuncs'); % save all the data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
